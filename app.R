...
tabPanel("Job Titles", 
  fluidPage(
  headerPanel('Hiring and Salaries by Title'),
  sidebarPanel(
...
tabPanel("Agencies", 
         fluidPage(
           headerPanel('Hiring and Salaries by Agency'),
           sidebarPanel(
             p("Select an agency below to see the average salary and count of jobs by year."),
             selectInput('agency', 'Agency Name', unique(dfa$agency), selected='ADMINISTRATION FOR CHILDRE'),
             tags$h5("Source: NYC Open Data")
             ),
           mainPanel(
             fluidRow(splitLayout(cellWidths = c("50%", "50%"),
